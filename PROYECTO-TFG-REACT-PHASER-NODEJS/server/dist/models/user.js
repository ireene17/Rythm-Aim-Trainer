...
const estadisticasSchema = new mongoose_1.default.Schema({
...
const userSchema = new mongoose_1.default.Schema({
    ...
    completados: [{ type: mongoose_1.default.Schema.Types.ObjectId, ref: 'Map' }],
    estadisticas: { type: estadisticasSchema, default: () => ({}) },
    fechaRegistro: { type: Date, default: Date.now }
});
exports.UserModel = mongoose_1.default.model("User", userSchema, "usuarios");
